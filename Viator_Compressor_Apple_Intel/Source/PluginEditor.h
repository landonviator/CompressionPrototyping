...
class Viator_Compressor_Mac_IntelAudioProcessorEditor  : public juce::AudioProcessorEditor, juce::Slider::Listener
{
public:
    Viator_Compressor_Mac_IntelAudioProcessorEditor (Viator_Compressor_Mac_IntelAudioProcessor&);
    ~Viator_Compressor_Mac_IntelAudioProcessorEditor() override;
...
private:
    ...
    Viator_Compressor_Mac_IntelAudioProcessor& audioProcessor;

    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (Viator_Compressor_Mac_IntelAudioProcessorEditor)
};
