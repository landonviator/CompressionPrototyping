...
//==============================================================================
Viator_Compressor_Mac_SiliconAudioProcessorEditor::Viator_Compressor_Mac_SiliconAudioProcessorEditor (Viator_Compressor_Mac_SiliconAudioProcessor& p)
...
Viator_Compressor_Mac_SiliconAudioProcessorEditor::~Viator_Compressor_Mac_SiliconAudioProcessorEditor()
{
}

//==============================================================================
void Viator_Compressor_Mac_SiliconAudioProcessorEditor::paint (juce::Graphics& g)
{
    g.fillAll(juce::Colour::fromFloatRGBA(0.14f, 0.16f, 0.2f, 1.0));

}

void Viator_Compressor_Mac_SiliconAudioProcessorEditor::resized()
{
    // This is generally where you'll want to lay out the positions of any
    // subcomponents in your editor..
}

void Viator_Compressor_Mac_SiliconAudioProcessorEditor::sliderValueChanged(juce::Slider *slider){
    for (size_t i {0}; i < sliders.size(); i++) {
